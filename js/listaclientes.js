...
const mostrarlistaClientes = (data) => {
    ...
    imprimir("listado", `<tableclass="container-fluid table table-bordered border-primary w-100 justify-content-start"><thead>${headerlista}</thead><tbody>${listadoCliente}<tbody></table>`)
